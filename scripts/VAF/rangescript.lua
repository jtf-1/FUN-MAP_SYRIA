...
range.strafeTargets = {

    {
        ...
        maxAlt = 3500,
        goodPass = 10,
        targets = {'Strafe pit Left 4','Strafe pit Left 3','Strafe pit Left 2','Strafe pit Left 1'}, -- which target(s) are valid for this zone - Unit Names
    },
	{    -- GROUP NAME for the unit whos waypoints enclose the target
        name = "Centre_zone",
		minAlt = 600,
        maxAlt = 3500,
        goodPass = 10,
        targets = {'Strafe pit Centre 4','Strafe pit Centre 3','Strafe pit Centre 2','Strafe pit Centre 1'}, -- which target(s) are valid for this zone - Unit Names
    },
    {
        ...
        maxAlt = 3500,
        goodPass = 10,
        targets = {'Strafe pit Right 4','Strafe pit Right 3','Strafe pit Right 2','Strafe pit Right 1'}, -- which target(s) are valid for this zone - Unit Names
    }
}

-- Zone Names
range.bombingMinAlt = 600
